...
const AgregarDependencia = ({ session, alumno }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        const response = await fetch(`${baseUrl}/alumnos/${alumno.id}`, {
            method: 'PUT',
            headers: {
                ...
                <div className="relative">
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="sticky top-0 bg-white dark:bg-gray-900">
                            <TextBlock title={'Nueva Alumno'} subtitle={'Agrega de manera individual información relevante de un alumno.attributes.'}>
...
export const getServerSideProps = async (context) => {
    ...
    const alumno = await dataApi(`${baseUrl}/alumnos?filters[matricula]=${context.params.matricula}`);
