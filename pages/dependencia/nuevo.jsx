...
import { addDependencia } from 'utils/strapi/dependencias';
...
const NuevaDependencia = ({ session }) => {
                ...
                <div className="relative">
                    <form onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <div className="sticky top-0 bg-white dark:bg-gray-900 z-50">
                            <TextBlock title={'Agregar Dependencia'} subtitle={'Agregue toda la información necesaria que compone a una dependencia.'}>
...
export default NuevaDependencia